        ...
        match s.split_once("\n") {
            Some((header, rest)) => {
                ...
                match rest.split_once("\r\n\r\n") {
                    ...
                    None => return Err(AspirinEatsError::InvalidRequest),
                }
            }
            None => return Err(AspirinEatsError::InvalidRequest),
        }
